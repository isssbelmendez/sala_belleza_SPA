...
$nombrePdf = 'Citas_Sala_Belleza' . date('Ymd_His') . '.pdf';
...
$sql = "SELECT citas.id_cita, citas.cliente, citas.fecha, citas.hora_inicio, 
        ...
        WHERE servicios.tipo_servicio_id = 1
...
$html .= '<div class="orange-spikes"></div>';
$html .= '<div class="page-header">
            <h1>Reporte de Citas de Sala de Belleza</h1>
          </div>';

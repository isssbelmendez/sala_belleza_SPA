...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert_servicio = "INSERT INTO servicios (nombre_servicio, tipo_servicio_id, precio, tiempo_estimado) 
                            VALUES ('$nombre_servicio', '$tipo_servicio_id', '$precio', '$tiempo_estimado')";

    if ($conn->query($sql_insert_servicio) === TRUE) {
        header("Location: ./servicio_select.php");
        exit();
    } else {
        echo '<div class="alert alert-danger" role="alert">
                Error al insertar el servicio: ' . $conn->error . '
              </div>';
    }
}
?>
...
<head>
    ...
    <title>Insertar Servicio - Beauty Salon y Spa</title>
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="./servicio_insert.php">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="tipo_servicio_id" name="tipo_servicio_id" required>
                            ...
                            while ($tipo_servicio = $result_tipos_servicio->fetch_assoc()) {
                                echo "<option value='{$tipo_servicio['id_tipo']}'>{$tipo_servicio['nombre_tipo']}</option>";
                            }
                            ?>
                        </select>
                    </div>
